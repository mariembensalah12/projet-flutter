      ...
      children: [
        AnimatedContainer(
          ...
          child: Opacity(
            ...
            child: LanguageTile(language: 'English', level: 'B2', percentage: 70, languageIcon: Icons.language),
          ),
        ),
        AnimatedContainer(
          ...
          child: Opacity(
            opacity: _showAnimation ? 1.0 : 0.0, // Animation d'opacité
            child: LanguageTile(language: 'French', level: 'B2', percentage: 80, languageIcon: Icons.language),
          ),
        ),
